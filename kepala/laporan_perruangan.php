                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Laporan per Ruangan</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12" style="min-height: 69%">    
                <div class="table-data__tool"  style="padding-top: 50px;">
                    <div class="table-data__tool-left">
                        <h3 class="title-5">Laporan per Ruangan</h3>
                    </div>
                ...
                <div class="row card-body" >
                    <div class="col-lg-12">
                      <h2 class="page-header" style="text-align: center;">
                        <i class="fa fa-bar-file"></i>LAPORAN LIMBAH MEDIS PER RUANGAN<br>UDD Palang Merah Indonesia Kabupaten Banyumas  
                      </h2>
                    </div>
                    <!-- /.col -->
                </div>
                
                <div class="table-responsive m-b-40 card-body" style="padding: 20px 10px 50px;">
                        ...
                        <tbody>
                            <?php
                                if(isset($_GET['keyword'])){
                                    $cari = $_GET['keyword'];
                                    $q_tabel = mysqli_query($connect, "SELECT nama_ruangan, nama_petugas, SUM(jumlah_masuk) AS total FROM limbah_masuk join ruangan on limbah_masuk.id_ruangan = ruangan.id_ruangan join petugas on limbah_masuk.id_petugas = petugas.id_petugas WHERE nama_ruangan LIKE '%$cari%' OR jumlah_masuk LIKE '%$cari%' OR nama_petugas LIKE '%$cari%' GROUP BY nama_ruangan, nama_petugas");
                                }else{
                                    $q_tabel = mysqli_query($connect, "SELECT nama_ruangan, nama_petugas, SUM(jumlah_masuk) AS total FROM limbah_masuk join ruangan on limbah_masuk.id_ruangan = ruangan.id_ruangan join petugas on limbah_masuk.id_petugas = petugas.id_petugas GROUP BY nama_ruangan, nama_petugas");
                                }
                                ...
                                <td class="text-center"> 
                                    <?php 
                                        if($tabel['total']<1000){
                                            ...
                                            $tabel['total']=$tabel['total']/1000;
                                            echo $tabel['total'] . ' Ton';
                                        }
                                    ?>
                                </td>
                                <td class="text-center">
                ...
                <div class="row" style="padding-left: 25px; padding-bottom: 15px;">
                    <div class="col-xs-12">
                      <a href="print_laporan_perruangan.php" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</a>
                    </div>
                </div>
                </section>
            </div>
