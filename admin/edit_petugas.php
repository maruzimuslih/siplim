                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow open" href="#">
                                ...
                                <span class="arrow up" style="padding-top: 23px;">
        ...
        <div class="page-container2 content-wrapper" style="min-height: 100%">
            ...
            <div class="col-lg-8" style="margin: 50px auto;">
                <div class="card">
                    ...
                    <?php
                      $q_tabel = mysqli_query($connect, "SELECT * FROM petugas join akun on petugas.id_akun = akun.id_akun where akun.id_akun='".$_GET['id_akun']."'");
                        $tabel = mysqli_fetch_array($q_tabel);
                    ?>
                    <div class="card-body card-block">
                        <form action="proses_edit_ptgs.php" method="post" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <input type="hidden" class="form-control" name="id_akun" value="<?php echo $_GET['id_akun']; ?>">
                                    <input type="text" name="nama" class="form-control" value="<?php echo $tabel['nama_petugas']; ?>">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="jabatan" class="form-control" required>
                                      ...
                                      <?php
                                         $q_jabatan = mysqli_query($connect, "SELECT * FROM petugas WHERE id_akun = '".$_GET['id_akun']."' ");
                                         $jabatan = mysqli_fetch_array($q_jabatan);
                                         if($jabatan['jabatan']=='petugas ruang'){
                                            echo "<option selected value='petugas ruang'>Petugas Ruangan</option>";
                                            echo "<option value='petugas tps'>Petugas TPS</option>";
                                         }elseif ($jabatan['jabatan']=='petugas tps') {
                                            echo "<option value='petugas ruang'>Petugas Ruangan</option>";
                                            echo "<option selected value='petugas tps'>Petugas TPS</option>";
                                         }else{
                                            echo "<option value='petugas ruang'>Petugas Ruangan</option>";
                                            echo "<option value='petugas tps'>Petugas TPS</option>";
                                         }
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="alamat" class="form-control" rows="3" cols="5"> <?php echo $tabel['alamat'];?> </textarea>
                                    <input type="hidden" class="form-control" name="id_kepala" value="1">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="no_hp" class="form-control" value="<?php echo $tabel['no_hp']; ?>">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="jk" class="form-control" required>
                                      ...
                                      <?php
                                         $q_jk = mysqli_query($connect, "SELECT * FROM petugas WHERE id_akun = '".$_GET['id_akun']."' ");
                                         $jk = mysqli_fetch_array($q_jk);
                                         if($jk['jenis_kelamin']=='laki-laki'){
                                            echo "<option selected value='laki-laki'>Laki-laki</option>";
                                            echo "<option value='perempuan'>Perempuan</option>";
                                         }elseif ($jk['jenis_kelamin']=='perempuan') {
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="username" class="form-control" value="<?php echo $tabel['username']; ?>">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="password" name="password" class="form-control" value="<?php echo $tabel['password']; ?>">
                            ...
                            <a href="kelola_petugas.php" class="btn btn-secondary btn-sm">
