                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Kelola Jenis Limbah</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12" style="min-height: 69%">    
                <div class="table-data__tool"  style="padding-top: 50px;">
                    <div class="table-data__tool-left">
                        <h3 class="title-5">Data Jenis Limbah</h3>
                    </div>
                ...
                <div class="table-data__tool">
                    ...
                    <div class="table-data__tool-right">
                        <a href="tambah_jenis.php" class="au-btn au-btn-icon au-btn--green au-btn--small"> 
                        ...
                        <tbody>
                            <?php
                                if(isset($_GET['keyword'])){
                                    $cari = $_GET['keyword'];
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM jenis_limbah WHERE jenis_limbah LIKE '%$cari%' ORDER BY id_jenis DESC");
                                }else{
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM jenis_limbah ORDER BY id_jenis DESC");
                                }
                            ...
                            <tr class="tr-shadow">
                                ...
                                <td class="text-center">
                                    <div class="table-data-feature p-l-35" style="justify-content: center;">
                                        ...
                                        <a href="edit_jenis.php?id_jenis=<?php echo $tabel['id_jenis']; ?>" class="item" data-placement="top" title="Edit">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <button class="item" data-placement="top" data-toggle="modal" data-target="#smallmodal<?php echo $tabel['id_jenis']; ?>" title="Delete">
                                            <i class="zmdi zmdi-delete"></i>
                                        </button>

                                        <div class="modal fade" id="smallmodal<?php echo $tabel['id_jenis']; ?>" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="hapus_jenis.php?id_jenis=<?php echo $tabel['id_jenis']; ?>" class="btn btn-primary">Ya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
