                        ...
                        <tbody>
                            <?php
                                if(isset($_GET['keyword'])){
                                    $cari = $_GET['keyword'];
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM limbah_keluar join tujuan on limbah_keluar.id_tujuan = tujuan.id_tujuan WHERE bukti_no_dokumen LIKE '%$cari%' OR nama_tujuan LIKE '%$cari%' OR tgl_keluar LIKE '%$cari%' OR jumlah_keluar LIKE '%$cari%' ORDER BY id_keluar DESC");
                                }else{
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM limbah_keluar join tujuan on limbah_keluar.id_tujuan = tujuan.id_tujuan ORDER BY id_keluar DESC");
                                }
                                $no = 0;
