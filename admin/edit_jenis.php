             ...
             <div class="col-lg-8" style="margin: 50px auto;">
                <div class="card">
                    <div class="card-header">
                        <strong>Edit Data Jenis Limbah</strong>
                    </div>
                    <?php
                      $q_tabel = mysqli_query($connect, "SELECT * FROM jenis_limbah where id_jenis='".$_GET['id_jenis']."'");
                        $tabel = mysqli_fetch_array($q_tabel);
                    ?>
                    <div class="card-body card-block">
                        <form action="proses_edit_jenis.php" method="post" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <input type="hidden" class="form-control" name="id_jenis" value="<?php echo $_GET['id_jenis']; ?>">
                                    <input type="text" name="jenis" class="form-control" value="<?php echo $tabel['jenis']; ?>">
                                </div>
                            </div>
                            ...
                            <a href="kelola_jenis.php" class="btn btn-secondary btn-sm">
