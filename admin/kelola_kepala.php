            ...
            <div class="col-md-12" style="min-height: 69%">    
                <div class="table-data__tool"  style="padding-top: 50px;">
                    <div class="table-data__tool-left">
                        <h3 class="title-5">Kelola Pimpinan</h3>
                    </div>
                ...
                <div class="table-data__tool">
                    ...
                    <div class="table-data__tool-right">
                        <a href="tambah_kepala.php" class="au-btn au-btn-icon au-btn--green au-btn--small"> 
                        ...
                        <tbody>
                            <?php
                                if(isset($_GET['keyword'])){
                                    $cari = $_GET['keyword'];
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM kepala join akun on kepala.id_akun = akun.id_akun WHERE nama_kepala LIKE '%$cari%' OR jabatan LIKE '%$cari%' OR username LIKE '%$cari%' OR password LIKE '%$cari%' ORDER BY id_kepala DESC");
                                }else{
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM kepala join akun on kepala.id_akun = akun.id_akun ORDER BY id_kepala DESC");
                                }
                            ...
                            <tr class="tr-shadow">
                                ...
                                <td class="text-center">
                                    <div class="table-data-feature">
                                        ...
                                        <a href="edit_kepala.php?id_akun=<?php echo $tabel['id_akun']; ?>" class="item" data-placement="top" title="Edit">
                                            ...
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="hapus_kepala.php?id_akun=<?php echo $tabel['id_akun']; ?>" class="btn btn-primary">Ya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
