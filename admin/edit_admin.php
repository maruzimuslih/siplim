            ...
            <!-- DATA TABLE -->
             <div class="col-lg-8" style="margin: 50px auto;">
                <div class="card">
                    ...
                    <?php
                      $q_tabel = mysqli_query($connect, "SELECT * FROM admin join akun on admin.id_akun = akun.id_akun where akun.id_akun='".$_GET['id_akun']."'");
                        $tabel = mysqli_fetch_array($q_tabel);
                    ?>
                    <div class="card-body card-block">
                        <form action="proses_edit_admin.php" method="post" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <input type="text" name="nama" class="form-control" value="<?php echo $tabel['nama_admin']; ?>">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                            ...
                            <a href="kelola_admin.php" class="btn btn-secondary btn-sm">
