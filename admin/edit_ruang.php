             ...
             <div class="col-lg-8" style="margin: 50px auto;">
                <div class="card">
                    <div class="card-header">
                        <strong>Edit Data Sumber Limbah</strong>
                    </div>
                    <?php
                      $q_tabel = mysqli_query($connect, "SELECT * FROM ruangan where id_ruangan='".$_GET['id_ruangan']."'");
                        $tabel = mysqli_fetch_array($q_tabel);
                    ?>
                    <div class="card-body card-block">
                        <form action="proses_edit_ruang.php" method="post" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">Nama Ruangan</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <!-- <input type="hidden" class="form-control" name="id_admin" value="<?php echo $profil['id_admin']; ?>"> -->
                                    <input type="hidden" class="form-control" name="id_ruangan" value="<?php echo $_GET['id_ruangan']; ?>">
                                    <input type="text" name="nama" class="form-control" value="<?php echo $tabel['nama_ruangan']; ?>">
                                </div>
                            </div>
                            ...
                            <a href="kelola_ruangan.php" class="btn btn-secondary btn-sm">
