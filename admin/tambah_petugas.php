            ...
            <div class="col-lg-8" style="margin: 50px auto;">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="proses_tambah_ptgs.php" method="post" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="jabatan" class="form-control" required>
                                      ...
                                      <option value="petugas ruang">Petugas Ruangan</option>
                                      <option value="petugas tps">Petugas TPS</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="alamat" class="form-control" rows="3" cols="5" required></textarea>
