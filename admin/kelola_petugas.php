            ...
            <div class="col-md-12" style="min-height: 69%">    
                <div class="table-data__tool"  style="padding-top: 50px;">
                    <div class="table-data__tool-left">
                        <h3 class="title-5">Kelola Petugas</h3>
                    </div>
                ...
                <div class="table-data__tool">
                    ...
                    <div class="table-data__tool-right">
                        <a href="tambah_petugas.php" class="au-btn au-btn-icon au-btn--green au-btn--small"> 
                        ...
                        <tbody>
                            <?php
                                if(isset($_GET['keyword'])){
                                    $cari = $_GET['keyword'];
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM petugas join akun on petugas.id_akun = akun.id_akun WHERE nama_petugas LIKE '%$cari%' OR jabatan LIKE '%$cari%' OR username LIKE '%$cari%' OR password LIKE '%$cari%' ORDER BY id_petugas DESC");
                                }else{
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM petugas join akun on petugas.id_akun = akun.id_akun ORDER BY id_petugas DESC");
                                }
                            ...
                            <tr class="tr-shadow">
                                ...
                                <td class="text-center">
                                    <?php echo $tabel['jabatan'];?>
                                </td>
                                <td class="text-center">
                                    <?php echo $tabel['alamat'];?>
                                </td>
                                <td class="text-center">
                                    <?php echo $tabel['no_hp'];?>
                                </td>
                                <td class="text-center">
                                    <?php echo $tabel['jenis_kelamin'];?>
                                </td>
                                <td class="text-center">
                                    <?php echo $tabel['username'];?>
                                </td>
                                <td class="text-center"> 
                                    <?php echo $tabel['password'];?>
                                </td>
                                <td class="text-center">
                                    <div class="table-data-feature">
                                        
                                        <a href="edit_petugas.php?id_akun=<?php echo $tabel['id_akun']; ?>" class="item" data-placement="top" title="Edit">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <button class="item" data-placement="top" data-toggle="modal" data-target="#smallmodal<?php echo $tabel['id_akun']; ?>" title="Delete">
                                            <i class="zmdi zmdi-delete"></i>
                                        </button>

                                        <div class="modal fade" id="smallmodal<?php echo $tabel['id_akun']; ?>" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="hapus_petugas.php?id_akun=<?php echo $tabel['id_akun']; ?>" class="btn btn-primary">Ya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
