                        ...
                        <tbody>
                            <?php
                                if(isset($_GET['keyword'])){
                                    $cari = $_GET['keyword'];
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM limbah_masuk join ruangan on limbah_masuk.id_ruangan = ruangan.id_ruangan WHERE jenis_limbah LIKE '%$cari%' OR nama_ruangan LIKE '%$cari%' OR tgl_masuk LIKE '%$cari%' OR jumlah_masuk LIKE '%$cari%' ORDER BY id_masuk DESC ");             
                                }else{
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM limbah_masuk join ruangan on limbah_masuk.id_ruangan = ruangan.id_ruangan ORDER BY id_masuk DESC");
                                }
                                $no = 0;
