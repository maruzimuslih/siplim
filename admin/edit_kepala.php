            ...
            <div class="col-lg-8" style="margin: 50px auto;">
                <div class="card">
                    <div class="card-header">
                        <strong>Edit Pimpinan</strong>
                    </div>
                    <?php
                      $q_tabel = mysqli_query($connect, "SELECT * FROM kepala join akun on kepala.id_akun = akun.id_akun where akun.id_akun='".$_GET['id_akun']."'");
                        $tabel = mysqli_fetch_array($q_tabel);
                    ?>
                    <div class="card-body card-block">
                        <form action="proses_edit_kepala.php" method="post" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <input type="text" name="nama" class="form-control" value="<?php echo $tabel['nama_kepala']; ?>">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="jabatan" class="form-control" value="<?php echo $tabel['jabatan']; ?>">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <input type="hidden" class="form-control" name="level" value="pimpinan">
                                </div>
                            </div>
                            ...
                            <a href="kelola_kepala.php" class="btn btn-secondary btn-sm">
