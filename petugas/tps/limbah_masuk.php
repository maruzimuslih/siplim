    ...
    <div class="page-wrapper">
        ...
        <!-- DATA TABLE -->
            <div class="col-md-12" style="min-height: 69%">    
                ...
                <div class="table-responsive m-b-40" style="overflow-x:visible">
                                    ...
                                    <?php
                                     if($tabel['status']==0){ ?>
                                        <form action="proses_validasi.php" method="post">
                                            <button class='btn-sm btn-success' data-placement='top' title='Validasi'> Validasi </button>
                                            <input type='hidden' name='validasi' value='1'>
                                            <input type='hidden' name='id_masuk' value="<?php echo $tabel['id_masuk']; ?>">
                                        </form>
                                     <?php
                                        }elseif ($tabel['status']==1) { ?>
                                        <span style='font-size: 14px; color:green;'> Sudah divalidasi </span>
                                     <?php 
                                        } ?>
                                </td>
                                <td class="text-center">
