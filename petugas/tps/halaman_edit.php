                            ...
                            <div class="col-lg-8" style="margin: 50px auto;">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Edit Limbah Keluar TPS</strong>
                                    </div>
                                    <?php
                                    
                                      $q_tabel = mysqli_query($connect, "SELECT * FROM limbah_keluar join tujuan on limbah_keluar.id_tujuan = tujuan.id_tujuan where limbah_keluar.id_keluar='".$_GET['id_keluar']."'");
                                    ...
                                    <div class="card-body card-block">
                                        <form action="proses_edit.php" method="post" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="disabled-input" class=" form-control-label">Tanggal Keluar</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="tgl_keluar" placeholder="<?php echo date("d-m-Y", strtotime($tabel['tgl_keluar'])); ?>" disabled="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" value="<?php echo $tabel['jumlah_keluar']; ?>" name="jumlah" class="form-control">
                                                        <input type="hidden" class="form-control" name="id_keluar" value="<?php echo $_GET['id_keluar']; ?>">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Tujuan Penyerahan</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <select name="id_tujuan" class="form-control" required>
                                                        <option value="" hidden > Pilih Tujuan</option>
                                                            <?php
                                                            $q_tujuan = mysqli_query($connect, "SELECT * FROM tujuan ORDER BY nama_tujuan");
                                                            while($tujuan = mysqli_fetch_array($q_tujuan)){
                                                            if($tujuan['id_tujuan']==$tabel['id_tujuan']){
                                                            echo "<option selected value='".$tujuan['id_tujuan']."'> ".$tujuan['nama_tujuan']." </option>";
                                                            }else{
                                                                echo "<option value='".$tujuan['id_tujuan']."'> ".$tujuan['nama_tujuan']." </option>";
                                                            }
                                                            }
                                                            ?>
                                                    </select>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Bukti No Dokumen</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="hidden" class="form-control" name="id_petugas" value="<?php echo $profil['id_petugas']; ?>">
                                                    <input type="text" name="bukti" value="<?php echo $tabel['bukti_no_dokumen']; ?>" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <a href="limbah_keluar.php ?>" class="btn btn-secondary btn-sm">
