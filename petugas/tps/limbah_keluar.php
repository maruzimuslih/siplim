                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Limbah Keluar TPS</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12" style="min-height: 69%">    
                <div class="table-data__tool"  style="padding-top: 50px;">
                    <div class="table-data__tool-left">
                        <h3 class="title-5">Limbah Keluar dari TPS</h3>
                    </div>
                        ...
                        <tbody>
                            <?php
                                if(isset($_GET['keyword'])){
                                    $cari = $_GET['keyword'];
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM limbah_keluar join tujuan on limbah_keluar.id_tujuan = tujuan.id_tujuan join petugas on limbah_keluar.id_petugas = petugas.id_petugas WHERE bukti_no_dokumen LIKE '%$cari%' OR nama_tujuan LIKE '%$cari%' OR tgl_keluar LIKE '%$cari%' OR jumlah_keluar LIKE '%$cari%' OR nama_petugas LIKE '%$cari%' ORDER BY id_keluar DESC");
                                }else{
                                    $q_tabel = mysqli_query($connect, "SELECT * FROM limbah_keluar join tujuan on limbah_keluar.id_tujuan = tujuan.id_tujuan join petugas on limbah_keluar.id_petugas = petugas.id_petugas ORDER BY id_keluar DESC");
                                }
                            ...
                            <tr class="tr-shadow">
                                ...
                                <td class="text-center">
                                    <?php echo date('d-m-Y',strtotime($tabel['tgl_keluar']));?>
                                </td>
                                <td class="text-center">
                                    <?php 
                                        if($tabel['jumlah_keluar']<1000){
                                            echo $tabel['jumlah_keluar'] .' Kg';        
                                        }else{
                                            $tabel['jumlah_keluar']=$tabel['jumlah_keluar']/1000;
                                            echo $tabel['jumlah_keluar'] . ' Ton';
                                        }
                                    ?>
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center"> 
                                    <?php echo $tabel['bukti_no_dokumen'];?>
                                </td>
                                <td class="text-center"> 
                                ...
                                ?>
                                    <td class="text-center">
                                        <div class="table-data-feature">
                                            ...
                                            <a href="halaman_edit.php?id_keluar=<?php echo $tabel['id_keluar']; ?>" class="item" data-placement="top" title="Edit">
                                                <i class="zmdi zmdi-edit"></i>
                                            </a>
                                            <button class="item" data-placement="top" data-toggle="modal" data-target="#smallmodal<?php echo $tabel['id_keluar']; ?>" title="Delete">
                                                <i class="zmdi zmdi-delete"></i>
                                            </button>

                                            <div class="modal fade" id="smallmodal<?php echo $tabel['id_keluar']; ?>" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-sm" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="proses_hapus.php?id_keluar=<?php echo $tabel['id_keluar']; ?>" class="btn btn-primary">Ya</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
